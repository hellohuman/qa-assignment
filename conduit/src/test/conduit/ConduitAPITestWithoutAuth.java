...
public class ConduitAPITestWithoutAuth {
	...
	public Object[][] loginData() {
		return new Object[][] { 
			{"zeroloose@gmail.com", "testing123", 200, "zeroloose", 108664 },
			{"zeroloose@gmail.co", "testing123", 422, "", 0 },
			{"zeroloose@gmail.com", "testing12", 422, "", 0 },
			{"", "testing123", 422, "", 0 },
			{"zeroloose@gmail.com", "", 422, "", 0 },
			{"", "", 422, "", 0 },
			};
	}
	@Test(dataProvider = "testDataForLogin")
	public void testLogin(String email, String password, int expectedStatusCode, String expectedUsername, int expectedID) throws InterruptedException {
	...
	public Object[][] signupData() {
		return new Object[][] { 
			{"zeroloose@gmail.com", "testing123", 200, "zeroloose"},
			{"zeroloose", "testing123", 422, "zeroloose"},
			{"", "testing123", 422, "zeroloose"},
			{"zeroloose@gmail.com", "abc", 422, "zeroloose"},
			{"zeroloose@gmail.com", "", 422, "zeroloose" },
			{"", "", 422, "zeroloose" },
			{"", "", 422, "" },
			};
	}
	@Test(dataProvider = "testDataForSignup")
	public void testSignup(String email, String password, int expectedStatusCode, String username) throws InterruptedException {
		...
		Response response = request.body("{\"user\":{\"email\":\""+ emailResult +"\", \"password\":\""+ password +"\", \"username\":\""+ usernameResult +"\"}}")
				.post("/users");
		Assert.assertEquals(response.getStatusCode(), expectedStatusCode);
		if (response.getStatusCode() == 200){
			String jsonString = response.asString();
